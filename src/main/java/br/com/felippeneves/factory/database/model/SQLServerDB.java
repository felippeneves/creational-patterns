...
public class SQLServerDB implements Database {
    ...
    public List<String> query(String sql) {
        ...
        System.out.println("Querying " + sql + " in SQLServer database");
    ...
    public int insert(List<Object> list) {
        System.out.println("Insert " + list.size() + " register in SQLServer database");
    ...
    public int update(String sql) {
        System.out.println("Uptade querry " + sql + " in SQLServer database");
    ...
    public int delete(String sql) {
        System.out.println("Delete querry " + sql + " in SQLServer database");
